  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Total Balance */}
        <div className="bg-[#252836] border border-gray-800 rounded-2xl p-8 hover:border-[#4a9d7e]/30 transition-all duration-300 group">
          <p className="text-gray-400 text-sm uppercase tracking-widest font-bold mb-2">Total Balance</p>
          <h2 className="text-4xl font-bold text-white mb-4">${portfolioData.totalBalance.toLocaleString('en-US', { minimumFractionDigits: 2 })}</h2>
      ...
      {/* Performance Chart */}
      <div className="bg-[#252836] border border-gray-800 rounded-2xl p-8">
